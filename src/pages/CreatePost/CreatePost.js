...
const CreatePost = () => {
  ...
  return (
    <div className={styles.create_post}>
      <h2>Criar post</h2>
      <p>Escreva sobre o que voce quiser e compartilhe o seu conhecimento</p>
      <form onSubmit={handleSubmit}>
        ...
        <label >
          <span>Tags</span>
          <input type="text" name='image' required placeholder='Insira as tags separadas por vírgula' onChange={(e) => setTags(e.target.value)} value={tags}/>
        </label>
